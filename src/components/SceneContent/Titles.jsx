...
function Titles() {
    ...
    return (
        <group>
            <Text fillOpacity={0} font={'./fonts/Oldenburg-Regular.ttf'} ref={textMesh1} position={[-1, 0.115, 0]} rotation={[270*Math.PI/180, 0, 90*Math.PI/180]}  fontSize={.95}>
                Joshua Evans
            </Text>

            <Text fillOpacity={0} font={'./fonts/JacquesFrancois-Regular.ttf'} ref={textMesh2} position={[0, 0.115, 0]} rotation={[270*Math.PI/180, 0, 90*Math.PI/180]}  fontSize={.6}>
                Web Development
            </Text>

            <Text fillOpacity={0} font={'./fonts/Yellowtail-Regular.ttf'} ref={textMesh3} position={[1, 0.115, 0]} rotation={[270*Math.PI/180, 0, 90*Math.PI/180]}  fontSize={.4}>
